...
class BaseTrainer:
    ...
    def __init__(self, model, loss, metrics, optimizer, resume, config, train_logger=None):
        ...
        summary(self.model, tuple(config['input_size']))
        if len(device_ids) > 1:
        ...
        ###
        self.avg_train_time_per_epoch = 0
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            # update avg train time per epoch
            self.avg_train_time_per_epoch = ((self.avg_train_time_per_epoch*i)+log['train_time'])/(i+1)
            i += 1
            log['avg_train_time_per_epoch'] = self.avg_train_time_per_epoch
